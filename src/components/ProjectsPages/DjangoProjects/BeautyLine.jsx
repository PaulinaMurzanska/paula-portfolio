                        ...
                        <div className="inner-container">
                            <div className='description'>
                                <div className="description-text">
                                    ...
                                    <p>This application works as a reservation system that can be used in any website. In this particular
                                        case, it is dedicated for a beauty studio, but this is only matter of styling. The code beneath gives possibility to use it
                                        across many businesses that could benefit from that kind of booking system.
                                    </p>
                                    <p>
                                        The App is a working solution for making reservation for specific date, specific service and for specific employee. After making
                                        reservation, user receive an unique code as a confirmation that booking process went successfully. Reservation is automatically
                                        placed in selected for chosen service, employee calendar. As the app has also an employee site.
                                    </p>
                                    <p>
                                     Employee, is added to the system by admin. After signing in to his account, employee can see all upcoming appointments
                                        that have been made for his name. Admin can see all reservations.
                                    </p>
                                    <p>
                                      The Django code solutions are a teamwork effect. All the visual effects are 100% my development. The app was about the calendar,
